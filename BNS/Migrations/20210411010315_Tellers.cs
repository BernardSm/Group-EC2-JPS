...
{
    public partial class Tellers : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userStreetName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    userCity = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    userParish = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TellerId = table.Column<int>(type: "int", maxLength: 8, nullable: false)
